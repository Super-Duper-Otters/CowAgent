...
class PluginManager:
    ...
    def register(self, name: str, desire_priority: int = 0, **kwargs):
        def wrapper(plugincls):
            ...
            # Legacy chat plugins are opt-in. New plugin entries written to
            # plugins.json stay disabled unless a plugin explicitly opts in.
            plugincls.enabled = kwargs.get("enabled", False)
